...
{
    // Register Natives
    CreateNative("ControlUberCharger4",Native_ControlUberCharger);
    CreateNative("SetUberCharger4",Native_SetUberCharger);
    RegPluginLibrary("ubercharger4");
...
{
    g_IsUberchargerOn = CreateConVar("sm_ubercharger4","1","Enable/Disable ubercharger",0);
    g_ChargeAmount = CreateConVar("sm_ubercharger_charge_amount4", "0.35", "Sets the amount of uber charge to add time for kritz.",
                                  0, true, 0.0, true, 1.0);

    g_ChargeTimer = CreateConVar("sm_ubercharger_charge_timer4", "1.0", "Sets the time interval for kritz",0);

    g_EnableBeacon = CreateConVar("sm_ubercharger_beacon4","1","Enable/Disable ubercharger beacon",0);
    g_BeaconTimer = CreateConVar("sm_ubercharger_beacon_timer4","3.0","Sets the time interval of beacons for ubercharger",0);
    g_BeaconRadius = CreateConVar("sm_ubercharger_beacon_radius4", "375", "Sets the radius for medic enhancer beacon's light rings.",
